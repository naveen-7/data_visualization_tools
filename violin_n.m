...
%% violin_n - Simple violin plot using matlab default kernel density estimation
% written/modified by naveen at CUMC on 4/2/2017
...
%%
function[h,L,MX,MED,bw]=violin_n(Y,varargin)
