function hpol = polar_nav(varargin)
...
Angles = 0 : 45 : 315;
hObjToDelete = zeros( length(Angles)-8, 1 );
k = 0;
for ang = Angles
    ...
    switch ang
        ...
        case 45
            set(hObj,'string','1');
        case 90
            set(hObj,'string','2','VerticalAlignment','Bottom');
        case 135
            set(hObj,'string','3');
        case 180
            set(hObj,'string','4','HorizontalAlignment','Right');
        case 225
            set(hObj,'string','5');
        case 270
            set(hObj,'string','6','VerticalAlignment','Top');
        case 315
            set(hObj,'string','7');
        otherwise
            k = k + 1;
